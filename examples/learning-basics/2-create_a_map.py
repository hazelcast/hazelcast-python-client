...
greetings_map = client.get_map("greetings_map").blocking()

# Map is empty on the first run. It will be non-empty if Hazelcast has data
# on this map
size_before = greetings_map.size()
print(f"Size before: {size_before}")

# Write data to map. If there is a data with the same key already, it will
# be overwritten
