...
from hazelcast.cp import _with_default_group_name, _get_object_name_for_proxy


class CPProxyManagerTest(unittest.TestCase):
    def test_with_default_group_name(self):
        self.assertEqual("test", _with_default_group_name("test@default"))
        self.assertEqual("test@custom", _with_default_group_name("test@custom"))

    def test_with_default_group_name_with_multiple_group_names(self):
        with self.assertRaises(AssertionError):
            _with_default_group_name("test@default@@default")
