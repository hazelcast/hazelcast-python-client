...
class ClientLabelsTest(HazelcastTestCase):
    ...
    def test_default_config(self):
        ...
        self.assertIsNone(self.get_labels_from_member(client.get_local_client().uuid))
    ...
    def test_provided_labels_are_received(self):
        ...
        self.assertEqual(b"test-label", self.get_labels_from_member(client.get_local_client().uuid))
