...
REQUEST_TYPE = MULTIMAP_ADDENTRYLISTENERTOKEY
RESPONSE_TYPE = 104
RETRYABLE = False


def calculate_size(name, key, include_value, local_only):
...
def encode_request(name, key, include_value, local_only):
    ...
    client_message = ClientMessage(payload_size=calculate_size(name, key, include_value, local_only))
