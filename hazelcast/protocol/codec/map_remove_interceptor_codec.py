...
# Generated("8d92197d9ee8b204a9da4902006d7be8")

# hex: 0x011500
REQUEST_MESSAGE_TYPE = 70912
# hex: 0x011501
...
def encode_request(name, id):
    ...
    client_message.operation_name = "Map.RemoveInterceptor"
    ...
    string_codec.encode(client_message, id)
