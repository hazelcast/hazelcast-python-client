...
_EVENT_PARTITION_LOST_LOST_BACKUP_COUNT_OFFSET = (
    _EVENT_PARTITION_LOST_PARTITION_ID_OFFSET + INT_SIZE_IN_BYTES
)
_EVENT_PARTITION_LOST_SOURCE_OFFSET = (
    _EVENT_PARTITION_LOST_LOST_BACKUP_COUNT_OFFSET + INT_SIZE_IN_BYTES
)
...
def handle(msg, handle_partition_lost_event=None):
    ...
    if (
        message_type == _EVENT_PARTITION_LOST_MESSAGE_TYPE
        and handle_partition_lost_event is not None
    ):
        initial_frame = msg.next_frame()
