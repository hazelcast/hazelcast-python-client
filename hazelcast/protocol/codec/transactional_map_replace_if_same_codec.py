...
def calculate_size(name, txn_id, thread_id, key, old_value, new_value):
...
def encode_request(name, txn_id, thread_id, key, old_value, new_value):
    ...
    client_message = ClientMessage(payload_size=calculate_size(name, txn_id, thread_id, key, old_value, new_value))
