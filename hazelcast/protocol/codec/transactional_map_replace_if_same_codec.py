...
# Generated("97e47f5b7a3b9a2058ab08ad3e047811")

# hex: 0x0E0A00
REQUEST_MESSAGE_TYPE = 920064
# hex: 0x0E0A01
...
def encode_request(name, txn_id, thread_id, key, old_value, new_value):
    ...
    client_message.operation_name = "TransactionalMap.ReplaceIfSame"
    ...
    DataCodec.encode(client_message, old_value)
    DataCodec.encode(client_message, new_value)
