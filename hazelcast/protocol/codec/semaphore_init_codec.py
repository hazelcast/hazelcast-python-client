...
# Generated("5917cc8b72e01b00b0cdb197897d002a")

# hex: 0x0C0100
REQUEST_MESSAGE_TYPE = 786688
# hex: 0x0C0101
RESPONSE_MESSAGE_TYPE = 786689
REQUEST_PERMITS_FIELD_OFFSET = PARTITION_ID_FIELD_OFFSET + Bits.INT_SIZE_IN_BYTES
...
def encode_request(group_id, name, permits):
    ...
    client_message.operation_name = "Semaphore.Init"
