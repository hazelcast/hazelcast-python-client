...
# Generated("ca0cdea82b64cfcc33f5b8bbb30d72ca")

# hex: 0x014500
REQUEST_MESSAGE_TYPE = 83200
# hex: 0x014501
...
REQUEST_MAX_IDLE_FIELD_OFFSET = REQUEST_TTL_FIELD_OFFSET + Bits.LONG_SIZE_IN_BYTES
REQUEST_INITIAL_FRAME_SIZE = REQUEST_MAX_IDLE_FIELD_OFFSET + Bits.LONG_SIZE_IN_BYTES
...
def encode_request(name, key, value, thread_id, ttl, max_idle):
    ...
    client_message.operation_name = "Map.PutTransientWithMaxIdle"
    ...
    fixed_size_types_codec.encode_long(initial_frame.content, REQUEST_MAX_IDLE_FIELD_OFFSET, max_idle)
