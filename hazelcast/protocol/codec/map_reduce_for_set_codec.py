...
REQUEST_TYPE = MAPREDUCE_FORSET
RESPONSE_TYPE = 117
RETRYABLE = False


def calculate_size(name, job_id, predicate, mapper, combiner_factory, reducer_factory, set_name, chunk_size, keys, topology_changed_strategy):
    ...
    data_size += calculate_size_str(set_name)
