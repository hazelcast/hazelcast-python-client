...
# Generated("83b8dda99442eba3c04ef611c26e9afb")

# hex: 0x000C00
REQUEST_MESSAGE_TYPE = 3072
# hex: 0x000C01
RESPONSE_MESSAGE_TYPE = 3073
REQUEST_TIMESTAMP_FIELD_OFFSET = PARTITION_ID_FIELD_OFFSET + Bits.INT_SIZE_IN_BYTES
REQUEST_INITIAL_FRAME_SIZE = REQUEST_TIMESTAMP_FIELD_OFFSET + Bits.LONG_SIZE_IN_BYTES
