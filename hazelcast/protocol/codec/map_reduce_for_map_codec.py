...
REQUEST_TYPE = MAPREDUCE_FORMAP
RESPONSE_TYPE = 117
RETRYABLE = False


def calculate_size(name, job_id, predicate, mapper, combiner_factory, reducer_factory, map_name, chunk_size, keys, topology_changed_strategy):
...
def encode_request(name, job_id, predicate, mapper, combiner_factory, reducer_factory, map_name, chunk_size, keys, topology_changed_strategy):
    """ Encode request into client_message"""
    client_message = ClientMessage(payload_size=calculate_size(name, job_id, predicate, mapper, combiner_factory, reducer_factory, map_name, chunk_size, keys, topology_changed_strategy))
