...
def calculate_size(name, thread_id, timeout, lock_name):
...
def encode_request(name, thread_id, timeout, lock_name):
    """ Encode request into client_message"""
    client_message = ClientMessage(payload_size=calculate_size(name, thread_id, timeout, lock_name))
