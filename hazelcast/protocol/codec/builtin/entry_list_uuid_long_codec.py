...
ENTRY_SIZE_IN_BYTES = FixedSizeTypesCodec.UUID_SIZE_IN_BYTES + FixedSizeTypesCodec.LONG_SIZE_IN_BYTES
...
class EntryListUUIDLongCodec:
    ...
    def encode(client_message, collection):
        ...
        for i, value in enumerate(collection):
            ...
            FixedSizeTypesCodec.encode_uuid(frame.content, i * ENTRY_SIZE_IN_BYTES + FixedSizeTypesCodec.UUID_SIZE_IN_BYTES, value)
    ...
    def decode(iterator):
        ...
        for i, value in range(item_count):
            ...
            value = FixedSizeTypesCodec.decode_long(frame.content, i * ENTRY_SIZE_IN_BYTES + FixedSizeTypesCodec.UUID_SIZE_IN_BYTES)
