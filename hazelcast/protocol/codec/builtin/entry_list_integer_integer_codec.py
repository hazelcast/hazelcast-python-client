...
def encode(client_message, collection):
    ...
    for i, value in enumerate(collection):
        ...
        fixed_size_types_codec.encode_int(frame.content, i * ENTRY_SIZE_IN_BYTES + INT_SIZE_IN_BYTES, value)
...
def decode(iterator):
    ...
    for i in range(item_count):
        ...
        value = fixed_size_types_codec.decode_int(frame.content, i*ENTRY_SIZE_IN_BYTES + INT_SIZE_IN_BYTES)
        result[key] = value
    return result
