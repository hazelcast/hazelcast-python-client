...
# Generated("789f0aa9406364b5411cef319df29151")

# hex: 0x170800
REQUEST_MESSAGE_TYPE = 1509376
# hex: 0x170801
RESPONSE_MESSAGE_TYPE = 1509377
REQUEST_OVERFLOW_POLICY_FIELD_OFFSET = PARTITION_ID_FIELD_OFFSET + Bits.INT_SIZE_IN_BYTES
REQUEST_INITIAL_FRAME_SIZE = REQUEST_OVERFLOW_POLICY_FIELD_OFFSET + Bits.INT_SIZE_IN_BYTES
...
def encode_request(name, value_list, overflow_policy):
    ...
    client_message.operation_name = "Ringbuffer.AddAll"
    initial_frame = ClientMessage.Frame(bytearray(REQUEST_INITIAL_FRAME_SIZE), UNFRAGMENTED_MESSAGE)
    FixedSizeTypesCodec.encode_int(initial_frame.content, TYPE_FIELD_OFFSET, REQUEST_MESSAGE_TYPE)
    FixedSizeTypesCodec.encode_int(initial_frame.content, PARTITION_ID_FIELD_OFFSET, -1)
    FixedSizeTypesCodec.encode_int(initial_frame.content, REQUEST_OVERFLOW_POLICY_FIELD_OFFSET, overflow_policy)
