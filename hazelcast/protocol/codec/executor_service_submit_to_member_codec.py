...
# Generated("599a47ce2db0d3112dee7af346633709")

# hex: 0x080600
REQUEST_MESSAGE_TYPE = 525824
# hex: 0x080601
RESPONSE_MESSAGE_TYPE = 525825
...
REQUEST_INITIAL_FRAME_SIZE = REQUEST_MEMBER_UUID_FIELD_OFFSET + Bits.UUID_SIZE_IN_BYTES
...
def encode_request(name, uuid, callable, member_uuid):
    ...
    client_message.operation_name = "ExecutorService.SubmitToMember"
