...
# Generated("8611d086c3f9c166d2d10cf02bf1fed5")

# hex: 0x090400
REQUEST_MESSAGE_TYPE = 590848
# hex: 0x090401
RESPONSE_MESSAGE_TYPE = 590849
REQUEST_EXPECTED_FIELD_OFFSET = PARTITION_ID_FIELD_OFFSET + Bits.INT_SIZE_IN_BYTES
REQUEST_UPDATED_FIELD_OFFSET = REQUEST_EXPECTED_FIELD_OFFSET + Bits.LONG_SIZE_IN_BYTES
REQUEST_INITIAL_FRAME_SIZE = REQUEST_UPDATED_FIELD_OFFSET + Bits.LONG_SIZE_IN_BYTES
...
def encode_request(group_id, name, expected, updated):
    ...
    client_message.operation_name = "AtomicLong.CompareAndSet"
    initial_frame = ClientMessage.Frame(bytearray(REQUEST_INITIAL_FRAME_SIZE), UNFRAGMENTED_MESSAGE)
    FixedSizeTypesCodec.encode_int(initial_frame.content, TYPE_FIELD_OFFSET, REQUEST_MESSAGE_TYPE)
    FixedSizeTypesCodec.encode_long(initial_frame.content, REQUEST_EXPECTED_FIELD_OFFSET, expected)
    FixedSizeTypesCodec.encode_long(initial_frame.content, REQUEST_UPDATED_FIELD_OFFSET, updated)
