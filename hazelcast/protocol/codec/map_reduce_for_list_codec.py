...
REQUEST_TYPE = MAPREDUCE_FORLIST
RESPONSE_TYPE = 117
RETRYABLE = False


def calculate_size(name, job_id, predicate, mapper, combiner_factory, reducer_factory, list_name, chunk_size, keys, topology_changed_strategy):
    ...
    data_size += calculate_size_str(list_name)
...
def encode_request(name, job_id, predicate, mapper, combiner_factory, reducer_factory, list_name, chunk_size, keys, topology_changed_strategy):
    """ Encode request into client_message"""
    client_message = ClientMessage(payload_size=calculate_size(name, job_id, predicate, mapper, combiner_factory, reducer_factory, list_name, chunk_size, keys, topology_changed_strategy))
    ...
    client_message.append_str(list_name)
