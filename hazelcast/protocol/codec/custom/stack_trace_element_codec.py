...
_INITIAL_FRAME_SIZE = (
    _LINE_NUMBER_ENCODE_OFFSET + INT_SIZE_IN_BYTES - 2 * SIZE_OF_FRAME_LENGTH_AND_FLAGS
)
...
class StackTraceElementCodec(object):
    ...
    def encode(buf, stack_trace_element, is_final=False):
        ...
        FixSizedTypesCodec.encode_int(
            initial_frame_buf, _LINE_NUMBER_ENCODE_OFFSET, stack_trace_element.line_number
        )
