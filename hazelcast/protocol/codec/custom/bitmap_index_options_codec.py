...
_INITIAL_FRAME_SIZE = (
    _UNIQUE_KEY_TRANSFORMATION_ENCODE_OFFSET
    + INT_SIZE_IN_BYTES
    - 2 * SIZE_OF_FRAME_LENGTH_AND_FLAGS
)
...
class BitmapIndexOptionsCodec(object):
    ...
    def encode(buf, bitmap_index_options, is_final=False):
        ...
        FixSizedTypesCodec.encode_int(
            initial_frame_buf,
            _UNIQUE_KEY_TRANSFORMATION_ENCODE_OFFSET,
            bitmap_index_options.unique_key_transformation,
        )
    ...
    def decode(msg):
        ...
        unique_key_transformation = FixSizedTypesCodec.decode_int(
            initial_frame.buf, _UNIQUE_KEY_TRANSFORMATION_DECODE_OFFSET
        )
