...
class Statistics:
    ...
    async def start(self):
        ...
        async def _statistics_task():
            ...
            try:
                ...
                self._statistics_task = asyncio.create_task(_statistics_task())
    ...
    async def _send_stats(self, collection_timestamp, attributes, metrics_blob, connection):
    ...
    def _add_tcp_metrics(self, compressor):
        self._add_tcp_metric(compressor, "bytesSend", self._reactor._bytes_sent)
        self._add_tcp_metric(compressor, "bytesReceived", self._reactor._bytes_received)
