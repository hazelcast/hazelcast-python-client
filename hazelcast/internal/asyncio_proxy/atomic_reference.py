...
class AtomicReference(BaseCPProxy, typing.Generic[ElementType]):
    ...
    async def compare_and_set(
        ...
        try:
            ...
            return await self._send_schema_and_retry(e, self.compare_and_set, expect, update)
    ...
    async def get(self) -> typing.Optional[ElementType]:
    ...
    async def set(self, new_value: typing.Optional[ElementType]) -> None:
        ...
        try:
            ...
            return await self._send_schema_and_retry(e, self.set, new_value)
    ...
    async def get_and_set(
        ...
        try:
            ...
            return await self._send_schema_and_retry(e, self.get_and_set, new_value)
    ...
    async def is_none(self) -> bool:
        ...
        """
        return await self.contains(None)

    async def clear(self) -> None:
        """Clears the current stored reference, so it becomes ``None``."""
        return await self.set(None)

    async def contains(self, value: typing.Optional[ElementType]) -> bool:
        ...
        try:
            ...
            return await self._send_schema_and_retry(e, self.contains, value)
    ...
    async def alter_and_get(self, function: typing.Any) -> typing.Optional[ElementType]:
        """Alters the currently stored reference by applying a function on it
        and gets the result.
    ...
    async def get_and_alter(self, function: typing.Any) -> typing.Optional[ElementType]:
        """Alters the currently stored reference by applying a function on it
    ...
    async def apply(self, function: typing.Any) -> typing.Optional[ElementType]:
